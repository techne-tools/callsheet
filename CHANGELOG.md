...
- itch.io publishing workflow failed on every release — `gh release download`
  ran without a checkout. Added checkout step; all release-tag inputs moved to
...
- Stronger palette — colour is enforced at the source, with a system/user
  dark theme variant
- Anchored error surface — errors are dismissed quietly (6s auto-clear + ×)

### Fixed

- Dark-mode card contrast — resolves theme once, drives CSS and colour
